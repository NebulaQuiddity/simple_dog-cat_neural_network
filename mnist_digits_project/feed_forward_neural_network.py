...
class FeedForwardNeuralNetwork:
    ...
    def test_network_visually(self, images, outputs):

        self.visual_outputs = outputs
    ...
    def show_images(self, images):
        ...
        print('actual class: ' + str(list(self.visual_outputs.transpose()[image_number]).index(np.amax(self.visual_outputs.transpose()[image_number]))))
